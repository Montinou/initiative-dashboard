-- Create function to execute CEO insights query
CREATE OR REPLACE FUNCTION public.execute_ceo_insights_query(p_tenant_id uuid)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
...
GRANT EXECUTE ON FUNCTION public.execute_ceo_insights_query TO authenticated;

-- Add comment
COMMENT ON FUNCTION public.execute_ceo_insights_query IS 'Generates comprehensive CEO dashboard data for AI insights generation';