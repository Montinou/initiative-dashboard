...
export function ProfileDropdown({ userProfile, showName = true }: ProfileDropdownProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className={cn(
          "absolute top-full mt-2 w-64 bg-gray-900/95 backdrop-blur-sm border border-gray-700 rounded-lg shadow-xl z-50 overflow-hidden",
          "right-0"
        )}>
          {/* User Info Header */}
          ...
          <div className="py-2">
            <Link href="/profile">
              <button
                ...
                className="w-full flex items-center px-4 py-2.5 text-gray-300 hover:bg-gray-700/50 hover:text-white transition-colors"
              >
